...
$output v_texcoord0, v_texcoord1, v_texcoord2, v_color4, v_texcoord3, v_texcoord5, v_texcoord4, v_normal, v_texcoord6, v_texcoord7
...
SAMPLER2D(s_heightTextureVert, 5);
uniform vec4 s_heightTextureVert_Res;
SAMPLER2D(s_heightTextureFrag, 4);
uniform vec4 s_heightTextureFrag_Res;
SAMPLER2D(s_sunShadowDepth, 6);
uniform vec4 s_sunShadowDepth_Res;
SAMPLER2D(s_texture0, 7);
uniform vec4 s_texture0_Res;
SAMPLER2D(s_texture1, 8);
uniform vec4 s_texture1_Res;
SAMPLER2D(s_texture2, 9);
