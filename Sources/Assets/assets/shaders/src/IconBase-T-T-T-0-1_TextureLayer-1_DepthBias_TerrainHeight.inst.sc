$input i_data1, i_data2, i_data3, i_data4, a_texcoord0, i_data0, a_position
...
vec4 pixelSize = i_data1.xyzw;
vec4 quatRot = i_data2.xyzw;
vec4 color0 = i_data3.xyzw;
vec4 color1 = i_data4.xyzw;
vec4 texcoord0 = a_texcoord0.xyzw;
vec3 iconPos = i_data0.xyz;
