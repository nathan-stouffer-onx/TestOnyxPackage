$input v_texcoord7, v_texcoord6, v_depth, v_texcoord5, v_texcoord4, v_texcoord3, v_texcoord2, v_texcoord1, v_bitangent, v_tangent, v_texcoord0, v_color4, v_color3, v_color2, v_color1
//includes
#include <common.sh>
#include "layers.sc"
