$input i_data2, i_data3, i_data4, a_position
$output v_texcoord0, v_color4, v_texcoord7, v_tangent, v_color3, v_texcoord1, v_texcoord2, v_bitangent, v_texcoord3, v_depth, v_texcoord4, v_texcoord5, v_color0, v_texcoord6
...
vec4 u_p1p2 = i_data3.xyzw;
vec4 u_endAngles = i_data4.xyzw;
